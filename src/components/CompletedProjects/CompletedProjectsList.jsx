...
import EditCompletedProjectsList from './EditCompletedProjectsList';

function CompletedProjectsList({data, updateMessage}) {
                ...
                <div>
                    <div className='CompletedProjectsList-main'>
                        <div className='CompletedProjectsList-main-inside'>
                                                ...
                                                <div className='detailsss-icons'>
                                                    ...
                                                    <div>
                                                        <img
                                                            ...
                                                            className='detailsss-iconsss'
                                                            alt='display'
                                                            onClick={() => handleViewClick(projectsList.id)}
                                                        />
                                                    </div>
                                                    <div>
                                                        <img
                            ...
                            ( 
                                <>
                                    <EditCompletedProjectsList data={selectedProject}/>
                                </>
                            )}
                        </div>
                    </div>
