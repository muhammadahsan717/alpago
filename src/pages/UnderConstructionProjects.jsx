...
import ProjectList from '../components/UnderConstruction/ProjectList';
...
function UnderConstructionProjects() {
    ...
    return (
        ...
        <div className='outside-dash'>
            <Sidebar data='UNDER CONSTRUCTION PROJECTS'/>
        </div>
        ...
        <div className='inside-home'>
                ...
                <div className='multiple-form'>
                    <div className='multiple-form-text'>                        
                        {shows ? (
                            <>
                                <div>
                                    <p className='form-text-main-headings'>UNDER CONSTRUCTION</p>
                                </div>
                            ...
                            <>
                                <div>
                                    <p className='form-text-main-headings'>EDIT UNDER CONSTRUCTION PROJECTS</p>
                                </div>
                            </>
                        )}
                    </div>
            ...
            <div className='about-text-area'>
                <ProjectList data={CompletedProjectsListData} updateMessage={updateMessage}/>
            </div>
